...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.tweener.simplemoviedb.core.glide.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.tweener.simplemoviedb.core.glide.GlideOptions().apply(toSet));
    }
  }
}
